...
async def process_multivoice_assign(msg):
    ...
    try:
        ...
        prompt = (
            ...
            "narratable sentence and its order: do not summarize, omit, invent, or duplicate text. "
            "You MUST keep all speech attributions (e.g., 'Charles, his grandfather, said.', 'his mother, Trina, replied.', "
            "'Charles finally replied.', 'Trina said harshly.') exactly as they appear in the original text, and assign "
            "them to the Narrator. Do NOT omit them or set omit_from_audio=true. Every single word of the author's original narrative, including "
            "these dialogue tags and attributions, must remain intact and be spoken by the TTS engine. "
            "You may make only minor punctuation changes for "
